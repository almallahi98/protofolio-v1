...
function Course(props:any) {
  return (
    <div className='inline-flex bg-gray-prim p-4 hover:bg-[#222222] border-2 border-gray-300 border-opacity-0 hover:border-2 hover:border-blue-prim  rounded shadow-lg'>
            ...
            <p className='text-gray-300 capitalize font-mono'>
                {props.text}
                <a href={props.link} className='text-blue-prim font-mono underline ml-1' 
